...
public class ProdutoService {
    ...
    public ProdutoModel atualizar(ProdutoDto dto, UUID id){
        ProdutoModel existente = produtoRepository.findById(id).orElseThrow(() -> new RuntimeException("Produto não encontrado"));
    ...
    public List<ProdutoModel> buscarPorNome(String nomeBuscar) {

        return produtoRepository.findByNomeContainingIgnoreCase(nomeBuscar);
